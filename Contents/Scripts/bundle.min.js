...
// set-token <token>
if(match=input.match(SET_TOKEN_FORMAT)){return this.setToken(match[1]);}// Matching:
// rails/rails#123
...
// rails/rails
else if(match=input.match(REPOSITORY_FORMAT)){var _owner=new Account(match[1]);var _repository=new Repository(_owner,match[2]);return this.openRepositoryMenu(_repository);}// Matching:
// 911a93ac
...
function openAccountRepositories(string){return app.openAccountRepositoriesMenu(string);}function shortenLink(link,details){return app.shortenLink(link);}

...
// rails/rails
else if(match=input.match(REPOSITORY_FORMAT)){var _owner=new Account(match[1]);return this.openRepositorysMenu(_owner,match[2]);}// Matching:
// 911a93ac

...
else if(match=input.match(ISSUE_OR_PR_FORMAT)){var owner=new Account(match[1]);var repository=new Repository(owner,match[2]);var issue=new Issue(repository,match[3]);//FIXME: If we're fuzzy searching as someone types, we can't immediately
// open the URL. We'll need to suggest a menu item, and then have the user
// click it.
return LaunchBar.openURL(issue.url);}// Matching:
// rails/rails
